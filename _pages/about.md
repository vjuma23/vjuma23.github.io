...
- Mechanochemical modelling
- Cancer growth and radiotherapy modelling
- Epidemiological modelling
- Numerical analysis and finite element methods
- Scientific computing with FEniCS/FEniCSx, MATLAB and Python

## Current research directions

My current work includes Floquet–Turing instabilities in oscillatory reaction–diffusion systems, mechanochemical models of capsular contracture, activator–inhibitor models of Rho GTPase signalling, and computational modelling of biological systems.
